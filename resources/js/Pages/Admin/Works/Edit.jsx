...
export default function Edit({ work }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        category: work.category || 'Web Design',
    });

    const [imagePreview, setImagePreview] = useState(work.image ? `/storage/${work.image}` : null);
        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center gap-4">
                    ...
                    <span>Edit Project: {work.title}</span>
                </div>
            }
        >
                        ...
                        <div className="bg-[#161616] p-8 rounded-3xl border border-white/5 space-y-6">
                            ...
                            <div>
                                ...
                                <Select
                                    ...
                                    classNamePrefix="rs"
                                />
                                <p className="text-gray-600 text-xs mt-2 italic">Search or type to select technologies from the list.</p>
                    ...
                    <div className="space-y-6">
                        <div className="bg-[#161616] p-8 rounded-3xl border border-white/5">
                            ...
                            <div className="relative group overflow-hidden rounded-2xl bg-white/2 border-2 border-dashed border-white/10 hover:border-isak-primary/50 transition-all aspect-video flex flex-col items-center justify-center text-center p-4">
                                {imagePreview ? (
                                    <>
                                        <img src={imagePreview} alt="Preview" className="absolute inset-0 w-full h-full object-cover z-0 transition-transform duration-500 group-hover:scale-110" />
                            ...
                            <p className="text-gray-600 text-xs mt-4 italic">Leave empty to keep the current image.</p>
                        </div>
                    </div>
